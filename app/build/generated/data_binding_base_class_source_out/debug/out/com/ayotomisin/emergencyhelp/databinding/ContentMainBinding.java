...
public final class ContentMainBinding implements ViewBinding {
  ...
  private ContentMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button help) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.help;
      Button help = rootView.findViewById(id);
      if (help == null) {
        break missingId;
      }

      return new ContentMainBinding((ConstraintLayout) rootView, help);
    }
